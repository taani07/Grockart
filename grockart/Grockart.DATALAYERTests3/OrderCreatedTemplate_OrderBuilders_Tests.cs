...
{
    [TestClass()]
    public class OrderCreatedTemplate_OrderBuilders_Tests
    {
        [TestMethod()]
        public void BuildOrder_1()
        {
            ...
            OrderDetailsTemplate OrderCreatedObj = new OrderCreatedTemplate(UserProfileObj, OrderObj);
            List<IOrderBuilderResponse> Output = OrderCreatedObj.BuildOrder();
