...
public partial class api_orders_ShippedGroupOrders : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (CookieProxy.Instance().HasKey("t"))
            {
                ...
                OrderTypeTemplate Order = new GroupOrderTemplate(UserProfileObj, OrderObj);
                ListOfOrders = Order.FetchShippedOrderID();
