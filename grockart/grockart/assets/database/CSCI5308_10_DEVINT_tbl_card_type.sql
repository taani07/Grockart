...
LOCK TABLES `tbl_card_type` WRITE;
/*!40000 ALTER TABLE `tbl_card_type` DISABLE KEYS */;
INSERT INTO `tbl_card_type` VALUES (1,'ACTIVE'),(2,'DELETED');
/*!40000 ALTER TABLE `tbl_card_type` ENABLE KEYS */;
UNLOCK TABLES;
