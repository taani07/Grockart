...
LOCK TABLES `tbl_address_type` WRITE;
/*!40000 ALTER TABLE `tbl_address_type` DISABLE KEYS */;
INSERT INTO `tbl_address_type` VALUES (1,'ACTIVE'),(2,'DELETED');
/*!40000 ALTER TABLE `tbl_address_type` ENABLE KEYS */;
UNLOCK TABLES;
